...
unsigned char DS1302_TIME[]={22,1,12,11,59,55,3}; //时间数组
...
unsigned char DS1302_ReadByte(unsigned char Command)		  //DS1302读取函数
{
...
{
	DS1302_WriteByte(DS1302_W_WP,0x00);  //解除写入保护
	...
	DS1302_WriteByte(DS1302_W_WP,0x80);  //添加写入保护
}
...
void DS1302_ReadTime()			 ////将时间读取到DS1302_TIME数组中
{
	...
	Temp = DS1302_ReadByte(DS1302_R_DAY);
